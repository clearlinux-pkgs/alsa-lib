...
%prep
%setup -q -n alsa-lib-1.2.7.1
cd %{_builddir}/alsa-lib-1.2.7.1
%patch1 -p1
pushd ..
cp -a alsa-lib-1.2.7.1 build32
popd
pushd ..
cp -a alsa-lib-1.2.7.1 buildavx2
popd
...
cp %{_builddir}/alsa-lib-1.2.7.1/aserver/COPYING %{buildroot}/usr/share/package-licenses/alsa-lib/e5872dbffaaad55b275bdbcb8b377385c655c5bc
pushd ../build32/
%make_install32
