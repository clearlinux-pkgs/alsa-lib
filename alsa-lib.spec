...
Source0  : https://www.alsa-project.org/files/pub/lib/alsa-lib-1.2.1.2.tar.bz2
...
%prep
%setup -q -n alsa-lib-1.2.1.2
cd %{_builddir}/alsa-lib-1.2.1.2
%patch1 -p1
pushd ..
cp -a alsa-lib-1.2.1.2 build32
popd
pushd ..
cp -a alsa-lib-1.2.1.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1575260855
...
cp %{_builddir}/alsa-lib-1.2.1.2/COPYING %{buildroot}/usr/share/package-licenses/alsa-lib/597bf5f9c0904bd6c48ac3a3527685818d11246d
cp %{_builddir}/alsa-lib-1.2.1.2/aserver/COPYING %{buildroot}/usr/share/package-licenses/alsa-lib/e5872dbffaaad55b275bdbcb8b377385c655c5bc
pushd ../build32/
%make_install32
