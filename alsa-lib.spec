...
Source0  : https://www.alsa-project.org/files/pub/lib/alsa-lib-1.2.13.tar.bz2
Source1  : https://www.alsa-project.org/files/pub/lib/alsa-lib-1.2.13.tar.bz2.sig
...
%setup -q -n alsa-lib-1.2.13
cd %{_builddir}/alsa-lib-1.2.13
%patch -P 1 -p1
pushd ..
cp -a alsa-lib-1.2.13 build32
popd
pushd ..
cp -a alsa-lib-1.2.13 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1731436819
