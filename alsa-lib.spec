...
Source0  : https://www.alsa-project.org/files/pub/lib/alsa-lib-1.2.12.tar.bz2
Source1  : https://www.alsa-project.org/files/pub/lib/alsa-lib-1.2.12.tar.bz2.sig
...
%setup -q -n alsa-lib-1.2.12
cd %{_builddir}/alsa-lib-1.2.12
%patch -P 1 -p1
pushd ..
cp -a alsa-lib-1.2.12 build32
popd
pushd ..
cp -a alsa-lib-1.2.12 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1718287516
